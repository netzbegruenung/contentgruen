...
| D-N13b | **Bild-Adressen Dritter** | `fe/app/beitragskarte/beitragskarte.component.html:121` (vorher `image-result-item.component.html:41`), `domain/models/image.py:37` | Der einzige Abruf, den der Browser der Nutzenden an einen fremden Server richtet — siehe X4 | ✓ Eigener Abschnitt „Bilder von fremden Servern" |
